...
public class ProjectController {
  ...
  public ProjectController(
      ...
      AddTeamMemberUseCase addTeamMemberUseCase, RemoveTeamMemberUseCase removeTeamMemberUseCase,
  ...
  @PreAuthorize("hasRole('USER')")
  public ResponseEntity<ProjectPresenter> addTeamMember(@RequestBody ProjectDto.AddTeamMemberDto dto) {
  ...
  @PreAuthorize("hasRole('USER')")
  public ResponseEntity<ProjectPresenter> removeTeamMember(@RequestBody ProjectDto.RemoveTeamMemberDto dto) {
